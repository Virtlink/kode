...
/** Tests the [JvmMethodModifiers] implementations. */
class JvmMethodModifiersTests {

    private fun create(value: Int): JvmMethodModifiers = JvmMethodModifiers(value)

    private fun from(modifiers: Iterable<JvmMethodModifiers>): JvmMethodModifiers = JvmMethodModifiers.from(modifiers)

    private fun getMembers(): List<JvmMethodModifiers> = JvmMethodModifiers.allMembers
