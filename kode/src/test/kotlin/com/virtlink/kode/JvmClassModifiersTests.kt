...
/** Tests the [JvmClassModifiers] implementations. */
class JvmClassModifiersTests {

    private fun create(value: Int): JvmClassModifiers = JvmClassModifiers(value)

    private fun from(modifiers: Iterable<JvmClassModifiers>): JvmClassModifiers = JvmClassModifiers.from(modifiers)

    private fun getMembers(): List<JvmClassModifiers> = JvmClassModifiers.allMembers
