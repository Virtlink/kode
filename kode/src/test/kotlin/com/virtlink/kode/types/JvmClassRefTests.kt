...
class JvmClassRefTests {
    ...
    fun `of(X_i) simple interface`() {
        ...
        assertEquals("com/virtlink/kode/types/I", classRef.internalName)
        assertEquals("com.virtlink.kode.types.I", classRef.javaName)
        assertEquals(JvmTypeSort.Class, classRef.sort)
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Lcom/virtlink/kode/types/I;", classRef.descriptor)
        assertEquals("Lcom/virtlink/kode/types/I;", classRef.signature)
    ...
    fun `of(X_itt) invariant type parameter`() {
        ...
        assertEquals("com/virtlink/kode/types/IT", classRef.internalName)
        assertEquals("com.virtlink.kode.types.IT", classRef.javaName)
        assertEquals(JvmTypeSort.Class, classRef.sort)
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Lcom/virtlink/kode/types/IT;", classRef.descriptor)
        assertEquals("Lcom/virtlink/kode/types/IT<TT;>;", classRef.signature)
    ...
    fun `of(X_iott) covariant type parameter`() {
        ...
        assertEquals("com/virtlink/kode/types/IOT", classRef.internalName)
        assertEquals("com.virtlink.kode.types.IOT", classRef.javaName)
        assertEquals(JvmTypeSort.Class, classRef.sort)
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Lcom/virtlink/kode/types/IOT;", classRef.descriptor)
        assertEquals("Lcom/virtlink/kode/types/IOT<TT;>;", classRef.signature)
    ...
    fun `of(X_iitt) contravariant type parameter`() {
        ...
        assertEquals("com/virtlink/kode/types/IIT", classRef.internalName)
        assertEquals("com.virtlink.kode.types.IIT", classRef.javaName)
        assertEquals(JvmTypeSort.Class, classRef.sort)
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Lcom/virtlink/kode/types/IIT;", classRef.descriptor)
        assertEquals("Lcom/virtlink/kode/types/IIT<TT;>;", classRef.signature)
    ...
    fun `of(X_ittw) wildcard invariant type parameter`() {
        ...
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Lcom/virtlink/kode/types/IT;", classRef.descriptor)
        assertEquals("Lcom/virtlink/kode/types/IT<-Ljava/lang/Object;>;", classRef.signature)
    ...
    fun `of(X_iottw) wildcard covariant type parameter`() {
        ...
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Lcom/virtlink/kode/types/IOT;", classRef.descriptor)
        assertEquals("Lcom/virtlink/kode/types/IOT<-Ljava/lang/Object;>;", classRef.signature)
    ...
    fun `of(X_iittw) wildcard contravariant type parameter`() {
        ...
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Lcom/virtlink/kode/types/IIT;", classRef.descriptor)
        assertEquals("Lcom/virtlink/kode/types/IIT<-Ljava/lang/Object;>;", classRef.signature)
    ...
    fun `of(X_ittb) B invariant type parameter`() {
        ...
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Lcom/virtlink/kode/types/IT;", classRef.descriptor)
        assertEquals("Lcom/virtlink/kode/types/IT<Lcom/virtlink/kode/types/B;>;", classRef.signature)
    ...
    fun `of(X_iottb) B covariant type parameter`() {
        ...
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Lcom/virtlink/kode/types/IOT;", classRef.descriptor)
        assertEquals("Lcom/virtlink/kode/types/IOT<Lcom/virtlink/kode/types/B;>;", classRef.signature)
    ...
    fun `of(X_iittb) B contravariant type parameter`() {
        ...
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Lcom/virtlink/kode/types/IIT;", classRef.descriptor)
        assertEquals("Lcom/virtlink/kode/types/IIT<Lcom/virtlink/kode/types/B;>;", classRef.signature)
