...
class JvmClassDeclTests {
    ...
    fun `of(C) top-level class`() {
        ...
        assertEquals("com/virtlink/kode/types", classDecl.pkg.internalName)
        assertEquals("com/virtlink/kode/types/C", classDecl.internalName)
        assertEquals("com.virtlink.kode.types.C", classDecl.javaName)
        assertEquals(emptyList<JvmTypeParam>(), classDecl.signature.typeParameters)
        assertNull(classDecl.enclosingClass)
        assertFalse(classDecl.isInterface)
        assertTrue(classDecl.isClass)
    ...
    fun `of(C_CIC) inner class`() {
        ...
        assertEquals("com/virtlink/kode/types", classDecl.pkg.internalName)
        assertEquals("com/virtlink/kode/types/C\$CIC", classDecl.internalName)
        assertEquals("com.virtlink.kode.types.C\$CIC", classDecl.javaName)
        assertEquals(emptyList<JvmTypeParam>(), classDecl.signature.typeParameters)
    ...
    fun `of(C_CNC) nested class`() {
        ...
        assertEquals("com/virtlink/kode/types", classDecl.pkg.internalName)
        assertEquals("com/virtlink/kode/types/C\$CNC", classDecl.internalName)
        assertEquals("com.virtlink.kode.types.C\$CNC", classDecl.javaName)
        assertEquals(emptyList<JvmTypeParam>(), classDecl.signature.typeParameters)
        assertNull(classDecl.enclosingClass)
        assertFalse(classDecl.isInterface)
        assertTrue(classDecl.isClass)
    ...
    fun `of(C_CNI) nested interface`() {
        ...
        assertEquals("com/virtlink/kode/types", classDecl.pkg.internalName)
        assertEquals("com/virtlink/kode/types/C\$CNI", classDecl.internalName)
        assertEquals("com.virtlink.kode.types.C\$CNI", classDecl.javaName)
        assertEquals(emptyList<JvmTypeParam>(), classDecl.signature.typeParameters)
        assertNull(classDecl.enclosingClass)
    ...
    fun `of(I) top-level interface`() {
        ...
        assertEquals("com/virtlink/kode/types", classDecl.pkg.internalName)
        assertEquals("com/virtlink/kode/types/I", classDecl.internalName)
        assertEquals("com.virtlink.kode.types.I", classDecl.javaName)
        assertEquals(emptyList<JvmTypeParam>(), classDecl.signature.typeParameters)
        assertNull(classDecl.enclosingClass)
        assertTrue(classDecl.isInterface)
        assertFalse(classDecl.isClass)
    ...
    fun `of(I_INC) nested class`() {
        ...
        assertEquals("com/virtlink/kode/types", classDecl.pkg.internalName)
        assertEquals("com/virtlink/kode/types/I\$INC", classDecl.internalName)
        assertEquals("com.virtlink.kode.types.I\$INC", classDecl.javaName)
        assertEquals(emptyList<JvmTypeParam>(), classDecl.signature.typeParameters)
        assertNull(classDecl.enclosingClass)
        assertFalse(classDecl.isInterface)
        assertTrue(classDecl.isClass)
    ...
    fun `of(I_INI) nested interface`() {
        ...
        assertEquals("com/virtlink/kode/types", classDecl.pkg.internalName)
        assertEquals("com/virtlink/kode/types/I\$INI", classDecl.internalName)
        assertEquals("com.virtlink.kode.types.I\$INI", classDecl.javaName)
        assertEquals(emptyList<JvmTypeParam>(), classDecl.signature.typeParameters)
        assertNull(classDecl.enclosingClass)
        assertTrue(classDecl.isInterface)
        assertFalse(classDecl.isClass)
    ...
    fun `of(GC) generic top-level class`() {
        ...
        assertEquals("com/virtlink/kode/types", classDecl.pkg.internalName)
        assertEquals("com/virtlink/kode/types/GC", classDecl.internalName)
        assertEquals("com.virtlink.kode.types.GC", classDecl.javaName)
        assertEquals(listOf(
    ...
    fun `of(GC_GCIC) generic inner class`() {
        ...
        assertEquals("com/virtlink/kode/types", classDecl.pkg.internalName)
        assertEquals("com/virtlink/kode/types/GC\$GCIC", classDecl.internalName)
        assertEquals("com.virtlink.kode.types.GC\$GCIC", classDecl.javaName)
        assertEquals(listOf(
            JvmTypeParam("T", JvmTypes.Object.ref()),
    ...
    fun `of(GC_GCNC) generic nested class`() {
        ...
        assertEquals("com/virtlink/kode/types", classDecl.pkg.internalName)
        assertEquals("com/virtlink/kode/types/GC\$GCNC", classDecl.internalName)
        assertEquals("com.virtlink.kode.types.GC\$GCNC", classDecl.javaName)
        assertEquals(listOf(
            JvmTypeParam("T", JvmTypes.Object.ref()),
            JvmTypeParam("U", JvmTypes.Object.ref()),
        ), classDecl.signature.typeParameters)
    ...
    fun `of(GC_GCNI) generic nested interface`() {
        ...
        assertEquals("com/virtlink/kode/types", classDecl.pkg.internalName)
        assertEquals("com/virtlink/kode/types/GC\$GCNI", classDecl.internalName)
        assertEquals("com.virtlink.kode.types.GC\$GCNI", classDecl.javaName)
        assertEquals(listOf(
            JvmTypeParam("T", JvmTypes.Object.ref()),
            JvmTypeParam("U", JvmTypes.Object.ref()),
        ), classDecl.signature.typeParameters)
    ...
    fun `of(GI) generic top-level interface`() {
        ...
        assertEquals("com/virtlink/kode/types", classDecl.pkg.internalName)
        assertEquals("com/virtlink/kode/types/GI", classDecl.internalName)
        assertEquals("com.virtlink.kode.types.GI", classDecl.javaName)
        assertEquals(listOf(
            JvmTypeParam("T", JvmTypes.Object.ref()),
        ), classDecl.signature.typeParameters)
        assertNull(classDecl.enclosingClass)
    ...
    fun `of(GI_GINC) generic nested class`() {
        ...
        assertEquals("com/virtlink/kode/types", classDecl.pkg.internalName)
        assertEquals("com/virtlink/kode/types/GI\$GINC", classDecl.internalName)
        assertEquals("com.virtlink.kode.types.GI\$GINC", classDecl.javaName)
        assertEquals(listOf(
            JvmTypeParam("T", JvmTypes.Object.ref()),
            JvmTypeParam("U", JvmTypes.Object.ref()),
        ), classDecl.signature.typeParameters)
    ...
    fun `of(GI_GINI) generic nested interface`() {
        ...
        assertEquals("com/virtlink/kode/types", classDecl.pkg.internalName)
        assertEquals("com/virtlink/kode/types/GI\$GINI", classDecl.internalName)
        assertEquals("com.virtlink.kode.types.GI\$GINI", classDecl.javaName)
        assertEquals(listOf(
            JvmTypeParam("T", JvmTypes.Object.ref()),
            JvmTypeParam("U", JvmTypes.Object.ref()),
        ), classDecl.signature.typeParameters)
    ...
    fun `of(GC2) generic class with various type parameters`() {
        ...
        assertEquals("com/virtlink/kode/types", classDecl.pkg.internalName)
        assertEquals("com/virtlink/kode/types/GC2", classDecl.internalName)
        assertEquals("com.virtlink.kode.types.GC2", classDecl.javaName)
        assertEquals(listOf(
            JvmTypeParam("T", JvmTypes.Object.ref()),
