...
/** Tests the [JvmParamModifiers] implementations. */
class JvmParamModifiersTests {

    private fun create(value: Int): JvmParamModifiers = JvmParamModifiers(value)

    private fun from(modifiers: Iterable<JvmParamModifiers>): JvmParamModifiers = JvmParamModifiers.from(modifiers)

    private fun getMembers(): List<JvmParamModifiers> = JvmParamModifiers.allMembers
