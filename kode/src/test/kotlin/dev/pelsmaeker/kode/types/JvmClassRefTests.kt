...
class JvmClassRefTests {
    ...
    fun `of(X_i) simple interface`() {
        ...
        assertEquals("dev/pelsmaeker/kode/types/I", classRef.internalName)
        assertEquals("dev.pelsmaeker.kode.types.I", classRef.javaName)
        assertEquals(JvmTypeSort.Class, classRef.sort)
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Ldev/pelsmaeker/kode/types/I;", classRef.descriptor)
        assertEquals("Ldev/pelsmaeker/kode/types/I;", classRef.signature)
    ...
    fun `of(X_itt) invariant type parameter`() {
        ...
        assertEquals("dev/pelsmaeker/kode/types/IT", classRef.internalName)
        assertEquals("dev.pelsmaeker.kode.types.IT", classRef.javaName)
        assertEquals(JvmTypeSort.Class, classRef.sort)
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Ldev/pelsmaeker/kode/types/IT;", classRef.descriptor)
        assertEquals("Ldev/pelsmaeker/kode/types/IT<TT;>;", classRef.signature)
    ...
    fun `of(X_iott) covariant type parameter`() {
        ...
        assertEquals("dev/pelsmaeker/kode/types/IOT", classRef.internalName)
        assertEquals("dev.pelsmaeker.kode.types.IOT", classRef.javaName)
        assertEquals(JvmTypeSort.Class, classRef.sort)
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Ldev/pelsmaeker/kode/types/IOT;", classRef.descriptor)
        assertEquals("Ldev/pelsmaeker/kode/types/IOT<TT;>;", classRef.signature)
    ...
    fun `of(X_iitt) contravariant type parameter`() {
        ...
        assertEquals("dev/pelsmaeker/kode/types/IIT", classRef.internalName)
        assertEquals("dev.pelsmaeker.kode.types.IIT", classRef.javaName)
        assertEquals(JvmTypeSort.Class, classRef.sort)
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Ldev/pelsmaeker/kode/types/IIT;", classRef.descriptor)
        assertEquals("Ldev/pelsmaeker/kode/types/IIT<TT;>;", classRef.signature)
    ...
    fun `of(X_ittw) wildcard invariant type parameter`() {
        ...
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Ldev/pelsmaeker/kode/types/IT;", classRef.descriptor)
        assertEquals("Ldev/pelsmaeker/kode/types/IT<-Ljava/lang/Object;>;", classRef.signature)
    ...
    fun `of(X_iottw) wildcard covariant type parameter`() {
        ...
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Ldev/pelsmaeker/kode/types/IOT;", classRef.descriptor)
        assertEquals("Ldev/pelsmaeker/kode/types/IOT<-Ljava/lang/Object;>;", classRef.signature)
    ...
    fun `of(X_iittw) wildcard contravariant type parameter`() {
        ...
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Ldev/pelsmaeker/kode/types/IIT;", classRef.descriptor)
        assertEquals("Ldev/pelsmaeker/kode/types/IIT<-Ljava/lang/Object;>;", classRef.signature)
    ...
    fun `of(X_ittb) B invariant type parameter`() {
        ...
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Ldev/pelsmaeker/kode/types/IT;", classRef.descriptor)
        assertEquals("Ldev/pelsmaeker/kode/types/IT<Ldev/pelsmaeker/kode/types/B;>;", classRef.signature)
    ...
    fun `of(X_iottb) B covariant type parameter`() {
        ...
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Ldev/pelsmaeker/kode/types/IOT;", classRef.descriptor)
        assertEquals("Ldev/pelsmaeker/kode/types/IOT<Ldev/pelsmaeker/kode/types/B;>;", classRef.signature)
    ...
    fun `of(X_iittb) B contravariant type parameter`() {
        ...
        assertEquals(JvmTypeKind.Object, classRef.kind)
        assertEquals("Ldev/pelsmaeker/kode/types/IIT;", classRef.descriptor)
        assertEquals("Ldev/pelsmaeker/kode/types/IIT<Ldev/pelsmaeker/kode/types/B;>;", classRef.signature)
