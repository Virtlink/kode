...
class JvmClassDeclTests {
    ...
    fun `of(GC) generic top-level class`() {
        ...
        assertEquals("dev/pelsmaeker/kode/types", classDecl.pkg.internalName)
        assertEquals("dev/pelsmaeker/kode/types/GC", classDecl.internalName)
    ...
    fun `of(GC_GCIC) generic inner class`() {
        ...
        assertEquals("dev/pelsmaeker/kode/types", classDecl.pkg.internalName)
        assertEquals("dev/pelsmaeker/kode/types/GC\$GCIC", classDecl.internalName)
        assertEquals("dev.pelsmaeker.kode.types.GC\$GCIC", classDecl.javaName)
        assertEquals(listOf(
            JvmTypeParam("T", JvmTypes.Object.ref()),
    ...
    fun `of(GC_GCNC) generic nested class`() {
        ...
        assertEquals("dev/pelsmaeker/kode/types", classDecl.pkg.internalName)
        assertEquals("dev/pelsmaeker/kode/types/GC\$GCNC", classDecl.internalName)
        assertEquals("dev.pelsmaeker.kode.types.GC\$GCNC", classDecl.javaName)
        assertEquals(listOf(
            JvmTypeParam("T", JvmTypes.Object.ref()),
            JvmTypeParam("U", JvmTypes.Object.ref()),
        ), classDecl.typeParameters)
    ...
    fun `of(GC_GCNI) generic nested interface`() {
        ...
        assertEquals("dev/pelsmaeker/kode/types", classDecl.pkg.internalName)
        assertEquals("dev/pelsmaeker/kode/types/GC\$GCNI", classDecl.internalName)
        assertEquals("dev.pelsmaeker.kode.types.GC\$GCNI", classDecl.javaName)
        assertEquals(listOf(
            JvmTypeParam("T", JvmTypes.Object.ref()),
            JvmTypeParam("U", JvmTypes.Object.ref()),
        ), classDecl.typeParameters)
    ...
    fun `of(GI) generic top-level interface`() {
        ...
        assertEquals("dev/pelsmaeker/kode/types", classDecl.pkg.internalName)
        assertEquals("dev/pelsmaeker/kode/types/GI", classDecl.internalName)
    ...
    fun `of(GI_GINC) generic nested class`() {
        ...
        assertEquals("dev/pelsmaeker/kode/types", classDecl.pkg.internalName)
        assertEquals("dev/pelsmaeker/kode/types/GI\$GINC", classDecl.internalName)
        assertEquals("dev.pelsmaeker.kode.types.GI\$GINC", classDecl.javaName)
        assertEquals(listOf(
            JvmTypeParam("T", JvmTypes.Object.ref()),
            JvmTypeParam("U", JvmTypes.Object.ref()),
        ), classDecl.typeParameters)
    ...
    fun `of(GI_GINI) generic nested interface`() {
        ...
        assertEquals("dev/pelsmaeker/kode/types", classDecl.pkg.internalName)
        assertEquals("dev/pelsmaeker/kode/types/GI\$GINI", classDecl.internalName)
        assertEquals("dev.pelsmaeker.kode.types.GI\$GINI", classDecl.javaName)
        assertEquals(listOf(
            JvmTypeParam("T", JvmTypes.Object.ref()),
            JvmTypeParam("U", JvmTypes.Object.ref()),
        ), classDecl.typeParameters)
    ...
    fun `of(GC2) generic class with various type parameters`() {
        ...
        assertEquals("dev/pelsmaeker/kode/types", classDecl.pkg.internalName)
        assertEquals("dev/pelsmaeker/kode/types/GC2", classDecl.internalName)
        assertEquals("dev.pelsmaeker.kode.types.GC2", classDecl.javaName)
        assertEquals(listOf(
            JvmTypeParam("T", JvmTypes.Object.ref()),
